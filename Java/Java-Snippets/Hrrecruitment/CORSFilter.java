...
public class CORSFilter implements Filter{
	...
	public void init(FilterConfig filterConfig) {
		//When we implement a functionality that can be called when automatically getting initialized
	}

	public void destroy() {
		//When we implement a functionality that can be called when getting destroyed
